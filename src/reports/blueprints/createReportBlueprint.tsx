...
export function createReportBlueprint(options: ReportBlueprintOptions) {
  const Blueprint: React.FC<ReportBlueprintProps> = ({
    reportId,
    defaultRequest,
    onRunResult,
    tablePortalId,
    ...
    const label = t(`blueprints.${options.blueprintKey}.label`, {
      defaultValue: "Landlord report",
    });
    const title = t(`blueprints.${options.blueprintKey}.title`, {
      defaultValue: options.title,
    });
    const description = t(`blueprints.${options.blueprintKey}.description`, {
