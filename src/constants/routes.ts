...
export const ADMIN_ROUTES = {
  ...
  OCCUPIED_MANAGEMENT: "/admin/occupied-management",
  PRICING_TEMPLATES: "/admin/pricing-templates",
  DISPUTES_CHECKTIME: "/admin/disputes-checktime",
} as const;
...
export const LANDLORD_ROUTES = {
  ...
  MY_WALLET: "/landlord/my-wallet",
  FEE_MANAGEMENT: "/landlord/fee-management",
} as const;
...
export const ROUTES = {
  ...
  ADMIN_SUPPORT: ADMIN_ROUTES.SUPPORT,
  ADMIN_OCCUPIED_MANAGEMENT: ADMIN_ROUTES.OCCUPIED_MANAGEMENT,
  ADMIN_PRICING_TEMPLATES: ADMIN_ROUTES.PRICING_TEMPLATES,
  ADMIN_DISPUTES_CHECKTIME: ADMIN_ROUTES.DISPUTES_CHECKTIME,
  ...
  LANDLORD_MY_WALLET: LANDLORD_ROUTES.MY_WALLET,
  LANDLORD_PAYMENT_HISTORY: LANDLORD_ROUTES.PAYMENT_HISTORY,
  LANDLORD_FEE_MANAGEMENT: LANDLORD_ROUTES.FEE_MANAGEMENT,
  ...
  TENANT_CANCEL_PAYMENT: TENANT_ROUTES.CANCEL_PAYMENT,
