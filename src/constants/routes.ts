...
export const LANDLORD_ROUTES = {
  ...
  REPORTS_BOOKING_SUMMARY: "/landlord/reports/booking-summary",
} as const;
...
export const ROUTES = {
  ...
  LANDLORD_REPORTS: LANDLORD_ROUTES.REPORTS,
  LANDLORD_PAYMENT_HISTORY: LANDLORD_ROUTES.PAYMENT_HISTORY,
  LANDLORD_REPORTS_BOOKING_SUMMARY: LANDLORD_ROUTES.REPORTS_BOOKING_SUMMARY,
