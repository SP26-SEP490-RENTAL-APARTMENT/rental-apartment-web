...
function CancelPayment() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-rose-50 flex items-center justify-center px-4 py-8">
      <Card className="w-full max-w-2xl rounded-2xl shadow-lg border-0 py-0 overflow-hidden">
        <CardHeader className="bg-linear-to-r from-red-600 to-rose-600 text-white">
          <div className="text-center py-8">
            ...
            <CardTitle className="text-3xl font-bold">
              {t("cancel.title") || "Payment Cancelled"}
            </CardTitle>
            <p className="text-rose-100 mt-2 font-medium">
              {t("cancel.subtitle") ||
        ...
        <CardContent className="pt-8 px-6 pb-8">
          ...
          <div className="flex flex-col gap-3 pt-2">
            <Button
              ...
              className="w-full h-12 bg-linear-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-bold gap-2 rounded-xl shadow-md hover:shadow-lg transition-all"
            >
              <Home className="h-4 w-4" />
              {t("cancel.backHome") || "Back to Home"}
            </Button>
          </div>
        </CardContent>
      </Card>
